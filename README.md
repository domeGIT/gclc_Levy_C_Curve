...
following iteration we replace given lines with the sides of the appropriate isosceles triangle.
The code in this repository shows an implementation of a function that constructs this fractal using
